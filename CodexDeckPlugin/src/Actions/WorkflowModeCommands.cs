...
public sealed class FastModeCommand : PluginDynamicCommand
{
    ...
    protected override BitmapImage GetCommandImage(string p, PluginImageSize s) => StatusImages.For(_status, s, StatusFrameStyle.FullBleed);
}
...
public sealed class ContinueNewTaskCommand : PluginDynamicCommand
{
    ...
    protected override BitmapImage GetCommandImage(string p, PluginImageSize s) => StatusImages.For(_status, s, StatusFrameStyle.InsetRail);
}
