...
| P1-07 | 1 | Packaged install/load acceptance | P0-01a | deterministic `.lplug4` is accepted, remains installed, and loads from a fresh plugin-service restart | In progress — deterministic USTAR packer and version 1.0.0 metadata exist; installer acceptance and post-install load remain unresolved. See `docs/19-agent-handoff.md` and ADR-017 |
...
| P2-01 | 2 | Workflow template launchers | P1-03, P1-05 | one configurable workflow action offers review/debug/refactor safely | In progress — convenience actions removed; user reports all current editor/status-image tests pass; verified launch paths remain |
| P2-02 | 2 | Fast Mode and Continue-in-New-Task controls | P1-03, P1-05 | commands are visibly configured and never reconstruct context | In progress — capability-gated plugin controls added; verified companion shortcuts remain |
