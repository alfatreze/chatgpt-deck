...
| P2-01 | 2 | Workflow template launchers | P1-03, P1-05 | one configurable workflow action offers review/debug/refactor safely | In progress — convenience actions removed; generic Workflow Template editor remains with physical registration, persistence, and launch paths pending |
