...
| P2-01 | 2 | Workflow template launchers | P1-03, P1-05 | review/debug/refactor are editable and safely dispatched | In progress — stable validated template model/store and UI actions are present; companion capability registration and editor integration remain |
