...
| P2-01 | 2 | Workflow template launchers | P1-03, P1-05 | review/debug/refactor are editable and safely dispatched | In progress — verified Action Editor API now has a compiling Review template probe; physical registration, list population, persistence, and launch paths remain |
