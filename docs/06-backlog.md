...
| R1-04 | remediation | Add real companion integration tests | R1-01, R1-02 | tests exercise live server auth, malformed input, unsupported actions, dispatch states, and reconnect | In progress — `scripts/companion_integration_test.py` passes live hello/auth/unsupported/malformed checks; reconnect and failure cases remain |
