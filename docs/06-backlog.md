...
| R1-04 | remediation | Add real companion integration tests | R1-01, R1-02 | tests exercise live server auth, malformed input, unsupported actions, dispatch states, and reconnect | In progress — live smoke covers hello/auth/unauthorized/unsupported/malformed/reconnect; dispatch-failure coverage remains |
