...
| P2-01 | 2 | Workflow template launchers | P1-03, P1-05 | review/debug/refactor are editable and safely dispatched | In progress — Review/Debug/Refactor actions are present and capability-gated; companion support and editable persistence remain |
